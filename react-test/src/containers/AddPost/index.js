...
import { createPost, createPostFinish } from "redux/post/post.slice";
...
function NewPost() {
  ...
  const { createSuccess } = useSelector((state) => state.posts);
      ...
      <Grid container spacing={5} alignItems="stretch">
        ...
        <Grid item xs={12} sm={6}>
          <ImageUpload
            ...
            image={
              formValues.image ? URL.createObjectURL(formValues.image) : null
            }
          />
        </Grid>
      </Grid>
